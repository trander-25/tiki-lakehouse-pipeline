...
- **Visualization**: Superset is used for dashboards and exploration.
...
| **Visualization** | BI Tool | 📊 Superset | Connects to DuckDB for dashboarding and ad hoc analysis. |
...
This starts MinIO, Postgres, and Superset with Docker Compose.
...
4. **Serving Layer**: Superset connects to the lakehouse outputs via DuckDB engine for visualizations.
